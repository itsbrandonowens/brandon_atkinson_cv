        ...
        <div className='personal_profile'>
            ...
            <div class="personal_profile_grid">
                ...
                <div class="personal_profile_grid_item">
                    ...
                    <p className="proText">Thank you for taking the time to look at my CV in React, I created this to try and set myself apart from other candidates and I hope it has done enough for you to consider me for this position! </p>
                </div>
